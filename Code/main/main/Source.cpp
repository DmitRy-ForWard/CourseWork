...
int main()
{
	...
	RenderWindow window(VideoMode(1000, 500), "RUN DF");

	Texture f;
	f.loadFromFile("D:/KFU/Programming/CourseWork/Pic/fon.png");
	Sprite fon(f);

	Texture e;
	e.loadFromFile("D:/KFU/Programming/CourseWork/Pic/earth.png");
	Sprite earth[3];
	for (int i = 0; i < 3; i++) {
	...
	Texture m;
	m.loadFromFile("D:/KFU/Programming/CourseWork/Pic/man.png");
	Sprite man(m);
	...
	Texture t;
	t.loadFromFile("D:/KFU/Programming/CourseWork/Pic/text.png");
	Sprite text(t);
	...
	Texture b;
	b.loadFromFile("D:/KFU/Programming/CourseWork/Pic/block.png");
	Sprite block[2];
	int bx[2], by[2], bty[2];
	for (int i = 0; i < 2; i++) {
	...
	Texture go;
	go.loadFromFile("D:/KFU/Programming/CourseWork/Pic/gameover.png");
	Sprite gameover(go);
	gameover.setPosition(400, 50);

	Texture sc;
	sc.loadFromFile("D:/KFU/Programming/CourseWork/Pic/score.png");
	Sprite score[5];
	float fs[5];
	for (int i = 0; i < 5; i++) {
